...
namespace CSFPOSWare.Models
{
    public class Item : BaseModel
    {
        ...
        public Nullable<Guid> WebDepartmentID { get; set; }
        ...
        public Nullable<Guid> MobileMessageID { get; set; }
        public string OverrideAutoMenuButtonSettingsGraphic { get; set; }
        public string AutoMenuText { get; set; }
        public Nullable<DateTime> AutoMenuStartDate { get; set; }
        public Nullable<DateTime> AutoMenuEndDate { get; set; }
